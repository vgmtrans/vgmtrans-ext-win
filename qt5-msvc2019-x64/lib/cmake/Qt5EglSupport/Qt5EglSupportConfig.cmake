...
set(Qt5EglSupport_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.14.2"
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.14.2/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5EglSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_EglSupport_process_prl_file(
            "${_qt5EglSupport_install_prefix}/lib/Qt5EglSupportd.prl" DEBUG
            _Qt5EglSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5EglSupport_STATIC_DEBUG_LINK_FLAGS
        )
    ...
    _populate_EglSupport_target_properties(RELEASE "Qt5EglSupport.lib" "" TRUE)



    _populate_EglSupport_target_properties(DEBUG "Qt5EglSupportd.lib" "" TRUE)
