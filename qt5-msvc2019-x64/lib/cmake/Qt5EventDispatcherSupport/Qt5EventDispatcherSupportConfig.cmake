...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_EventDispatcherSupport_process_prl_file(
            "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupportd.prl" DEBUG
            _Qt5EventDispatcherSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5EventDispatcherSupport_STATIC_DEBUG_LINK_FLAGS
        )
    ...
    _populate_EventDispatcherSupport_target_properties(RELEASE "Qt5EventDispatcherSupport.lib" "" TRUE)



    _populate_EventDispatcherSupport_target_properties(DEBUG "Qt5EventDispatcherSupportd.lib" "" TRUE)
