...
set_target_properties(Qt6::syncqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/syncqt.exe"
  )
...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/moc.exe"
  )
...
set_target_properties(Qt6::tracepointgen PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/tracepointgen.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::tracepointgen )
list(APPEND _cmake_import_check_files_for_Qt6::tracepointgen "${_IMPORT_PREFIX}/./bin/tracepointgen.exe" )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/tracegen.exe"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/cmake_automoc_parser.exe"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/./bin/qlalr.exe"
  )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/qtpaths.exe"
  )
...
set_target_properties(Qt6::androiddeployqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/androiddeployqt.exe"
  )
...
set_target_properties(Qt6::androidtestrunner PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/androidtestrunner.exe"
  )
